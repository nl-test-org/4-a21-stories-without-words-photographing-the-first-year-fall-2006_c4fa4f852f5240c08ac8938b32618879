...
menu:
  leftnav:
    identifier: 838a2da927af0be52f5edc7522c8f27f
    name: Assignments
    weight: 50
title: Assignments
type: course
uid: 838a2da927af0be52f5edc7522c8f27f
...
| WEEK # | TOPICS |
| --- | --- |
| 1 | Lecture - Introduction: 9/11 / Camera, Light ([PDF]({{< baseurl >}}/sections/assignments/assn0)) |
| 2 | Image Viewing - Light Assignment ([PDF]({{< baseurl >}}/sections/assignments/assn1)) |
| 3 | Image Viewing - Detail Assignment / Web Design ([PDF]({{< baseurl >}}/sections/assignments/assn2)) |
| 4 | Museum Visit - HMNH, Dinner in Harvard Square |
| 5 | In-class Work on Web Site Building ([PDF]({{< baseurl >}}/sections/assignments/assn3)) |
| 6 | Review of Assignment 3 - Web Sites / Themes |
| 7 | Optional Class Meeting Due to Midterm Exams ([PDF]({{< baseurl >}}/sections/assignments/assn4)) |
| 8 | Image Viewing - Poetics Assignment, Themes |
| 9 | Walking Tour of Campus Art and Architecture |
| 10 | Working Session in Lab - Individual Review ([PDF]({{< baseurl >}}/sections/assignments/assn5)) |
